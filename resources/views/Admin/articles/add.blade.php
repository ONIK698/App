...
?>
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        ...
        <p>Название товара:<br><input type="text" name="title" class="form-control" required> </p>
        <p>Автор:<br><input type="text" name="author" class="form-control" required> </p>
        <p>Короткое описание:<br><textarea name="short_text" class="form-control"></textarea></p>
        <p>Полное описание:<br><textarea name="full_text" class="form-control"></textarea></p>
